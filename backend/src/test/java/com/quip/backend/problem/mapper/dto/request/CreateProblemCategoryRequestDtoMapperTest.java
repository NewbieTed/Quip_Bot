...
/**
 * Unit tests for {@link CreateProblemCategoryRequestDtoMapper}.
 * <p>
 * This test class validates the problem category request DTO mapper functionality.
 * It ensures the MapStruct interface can be processed without errors.
 * </p>
 */
@ExtendWith(MockitoExtension.class)
@DisplayName("CreateProblemCategoryRequestDtoMapper Tests")
public class CreateProblemCategoryRequestDtoMapperTest extends BaseTest {
    ...
    void shouldInstantiateMapper_Successfully() {
        ...
        assertNotNull(CreateProblemCategoryRequestDtoMapper.class);
    }
}