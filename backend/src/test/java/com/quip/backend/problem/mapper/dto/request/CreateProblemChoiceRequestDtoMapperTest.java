...
/**
 * Unit tests for {@link CreateProblemChoiceRequestDtoMapper}.
 * <p>
 * This test class validates the problem choice request DTO mapper functionality.
 * It ensures the MapStruct interface can be processed without errors.
 * </p>
 */
@ExtendWith(MockitoExtension.class)
@DisplayName("CreateProblemChoiceRequestDtoMapper Tests")
public class CreateProblemChoiceRequestDtoMapperTest extends BaseTest {
    ...
    void shouldInstantiateMapper_Successfully() {
        ...
        assertNotNull(CreateProblemChoiceRequestDtoMapper.class);
    }
}