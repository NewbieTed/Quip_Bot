...
/**
 * Unit tests for {@link GetProblemCategoryResponseDtoMapper}.
 * <p>
 * This test class validates the problem category response DTO mapper functionality.
 * It ensures the MapStruct interface can be processed without errors.
 * </p>
 */
@ExtendWith(MockitoExtension.class)
@DisplayName("GetProblemCategoryResponseDtoMapper Tests")
public class GetProblemCategoryResponseDtoMapperTest extends BaseTest {
    ...
    void shouldInstantiateMapper_Successfully() {
        ...
        assertNotNull(GetProblemCategoryResponseDtoMapper.class);
    }
}