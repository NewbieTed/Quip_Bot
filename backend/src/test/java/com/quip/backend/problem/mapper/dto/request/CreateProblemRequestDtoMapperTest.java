...
/**
 * Unit tests for {@link CreateProblemRequestDtoMapper}.
 * <p>
 * This test class validates the problem request DTO mapper functionality.
 * It ensures the MapStruct interface can be processed without errors.
 * </p>
 */
@ExtendWith(MockitoExtension.class)
@DisplayName("CreateProblemRequestDtoMapper Tests")
public class CreateProblemRequestDtoMapperTest extends BaseTest {
    ...
    void shouldInstantiateMapper_Successfully() {
        ...
        assertNotNull(CreateProblemRequestDtoMapper.class);
    }
}